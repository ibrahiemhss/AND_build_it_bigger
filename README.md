...
of four modules. A Java library that provides getJokeFromJava, a Google Cloud Endpoints
(GCE) project that serves those getJokeFromJava, an Android Library containing an
activity for displaying getJokeFromJava, and an Android app that fetches getJokeFromJava from the
...
Your first task is to create a Java library that provides getJokeFromJava. Create a new
...
This next task will be pretty tricky. Instead of pulling getJokeFromJava directly from
our Java library, we'll set up a Google Cloud Endpoints development server,
and pull our getJokeFromJava from there. The starter code already includes the GCE module
...
and your GCE module, and modify the GCE starter code to pull getJokeFromJava from your Java library.
Create an AsyncTask to retrieve getJokeFromJava using the template included int these
...
* Project contains a Java library for supplying getJokeFromJava
* Project contains an Android library with an activity that displays getJokeFromJava passed to it as intent extras.
* Project contains a Google Cloud Endpoints module that supplies getJokeFromJava from the Java library. Project loads getJokeFromJava from GCE module via an async task.
* Project contains connected tests to verify that the async task is indeed loading getJokeFromJava.
* Project contains paid/free flavors. The paid flavor has no ads, and no unnecessary dependencies.

### Required Behavior

* App retrieves getJokeFromJava from Google Cloud Endpoints module and displays them via an Activity from the Android Library.
